...
| F2-T02 | Construir e provar a consolidação no Skip | Ethos | SPEC-2-001 | CA-2-001..006 | Fluxo e regras; TDD da SPEC | RED + GREEN período B-107 + REGRESSÃO | Testes, capturas do preview, evidência `artifacts/` | F2-T01 aceita; Anexo F vigente | Consolidação lê e não escreve; F1 intacta | 2 | PENDENTE — próxima task elegível; análise e autorização ainda não iniciadas |

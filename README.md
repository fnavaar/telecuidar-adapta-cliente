...
2. Consulte `.adapta-cliente/estado-atual.md`.
3. Abra `04_fase-atual/fase.md` e a SPEC da task autorizada.
4. Execute uma task por vez, rode o TDD e peça teste humano.

...
- 2026-09-11 · Daniela · Task F1-T03 concluída: CA-1-007/008 aprovados; diff catálogo×Anexo E limpo; Anexo F aceito; B-104/B-105 fechados; nenhuma migration, modelo ou dado real criado.
- 2026-09-11 · Daniela · ANÁLISE F1-T04: baseline Skip 57934 sem migrations e somente coleção `users`; preview atual é apenas a sonda F1-T02 com 4/4 cenários sintéticos aprovados; não há formulário, lista, coleção financeira ou persistência de lançamentos. DÚVIDA bloqueante: participante, referência documental e distinção/modelagem de aporte versus saída não foram definidos nos artefatos aceitos; nenhuma alteração de produto feita.
- 2026-09-11 · Cliente · decisões F1-T04: `Responsável Pagamento` reutilizado como participante com os valores aprovados; `Referência Documental` definida como texto obrigatório sem integração Drive nesta task; `Tipo de Lançamento` definido como campo obrigatório com `Aporte` e `Saída`; plano atualizado e aguardando autorização explícita para implementar.
